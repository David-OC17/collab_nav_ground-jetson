...
(\subsys{security\_middleware})~\cite{repo}. Functionality is decomposed into the subsystems
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{VI_D-drone_trajectory_following.png}
\caption{UAV tracking the commanded boustrophedon survey trajectory under
OptiTrack feedback. \TODO{Add quantitative tracking-error annotation.}}
...
Experiments were run in the $4\times4$~m arena of Fig.~\ref{fig:arena}, with
cardboard-box obstacles and floor-mounted ArUco markers; OptiTrack provides
millimetre-accurate ground truth for both robots. \TODO{Obstacle configurations,
marker placement, number of runs.}
...
800-38D, 2007.
\bibitem{repo} ``Cooperative UAV--AMR navigation project repositories
(\subsys{collab\_nav\_ground-jetson}, \subsys{collab\_nav\_ground-rasp},
\subsys{security\_middleware}),'' 2026. \TODO{Insert public repository URLs.}
\end{thebibliography}
